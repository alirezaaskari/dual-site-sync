			...
			'sync' => array(
				...
				'fields' => array(
					...
					'sync_variation_images'     => array(
						'type'  => 'checkbox',
						'label' => 'تصویر واریشن‌ها و تصاویر اضافی آن‌ها منتقل شود',
						'desc'  => 'شامل تصویر اصلی واریشن و فیلد «Additional images» افزونه‌های تصاویر اضافی. '
							. 'اگر واریشن مبدأ تصویر اضافی نداشته باشد، فهرست مقصد هم <strong>پاک می‌شود</strong> تا دو سایت دقیقاً یکی باشند. '
							. 'اگر واریشن مبدأ اصلاً تصویر اصلی نداشته باشد، تصویر واریشن مقصد دست‌نخورده می‌ماند.',
					),
		...
		<div class="wrap dss-settings">
			...
			<table class="widefat striped dss-status-table">
				<tbody>
					...
					<tr>
						<th>تصاویر اضافی واریشن</th>
						<td>
							<?php $gallery_keys = DSS_Variation_Gallery::detected_keys(); ?>
							<?php if ( empty( $gallery_keys ) ) : ?>
								<span class="dss-muted">افزونه‌ای شناسایی نشد</span>
							<?php else : ?>
								<span class="dss-good"><?php echo esc_html( implode( '، ', $gallery_keys ) ); ?></span>
							<?php endif; ?>
						</td>
					</tr>
					<tr>
